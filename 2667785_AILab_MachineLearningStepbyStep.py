...
# ***Markdown Cell***
# 1. [Workflow](https://monkeylearn.com/static/17bfbafbae6490f0a06e7a8773373536/d040e/train3.png)
...
# 4. In my peer groups, we discussed comments and machine learning code. Adding comments to code is very critical, not only for engaging a wider audience but also for keeping track of progress. Because code can vary and still achieve the same end result, comments are a good information management practice. information management practice.
